          ...
          <div className="grid grid-cols-12 font-sans">
            <div className="col-span-12 md:col-span-12 lg:col-span-12 mr-3">
              <div className="lg:px-6 pt-4 lg:pl-40 lg:pr-40 md:pl-5 md:pr-5 flex-grow scrollbar-hide w-full max-h-full pb-0">
                ...
                {/* OPENING TIME */}
                {/* <div className="flex px-3 py-3  items-center justify-center gap-3 mb-6 rounded-lg bg-slate-200 dark:bg-slate-600 w-full h-full">
                  <div className="w-full flex flex-col border-b border-b-slate-400">
                    {" "}
                    <h1 className="block text-[18px] font-semibold text-gray-600 dark:text-gray-400 sm:col-span-2">
                      Business Hours
                    </h1>{" "}
                    <p className="block text-[10px] font-semibold text-gray-600 dark:text-gray-400 mb-2 sm:col-span-2">
                      This is your business opening and closing time
                    </p>
                  </div>
                </div>
                {/* END OF OPENING TIME */}
