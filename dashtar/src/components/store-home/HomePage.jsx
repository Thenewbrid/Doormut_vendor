    ...
    <>
      <div className="grid grid-cols-12 font-sans pr-4">
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12">
          ...
          <div className="flex flex-col items-start justify-start xl:px-10">
            <div className="inline-flex md:text-base text-sm my-3 text-gray-500 dark:text-gray-400">
              <strong>{t("Banner And Logo")}</strong>
            </div>
            <hr className="md:mb-12 mb-3" />

            <div className="flex items-center justify-center w-full gap-5">
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative w-full">
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative w-full">
                ...
                <div className="sm:col-span-4">
                  <Uploader imageUrl={storeLogo} setImageUrl={setStoreLogo} />
                </div>
              </div>
            </div>
          </div>
          {/* END OF BANNER AND LOGO SECTION */}
